...
GATEWAY_ENV_URL = "https://ui.adsabs.harvard.edu/"

ARTICLES_MANIFEST_PATH = "scan/manifest"

VALID_REFERRERS = ["ui.adsabs.harvard.edu", "dev.adsabs.harvard.edu", "qa.adsabs.harvard.edu", "scixplorer.org", "qa.scixplorer.org", "dev.scixplorer.org"]